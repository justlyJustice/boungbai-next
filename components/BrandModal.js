...
export const FirstModal = ({ showModal, setShowModal }) => {
        ...
        >
          <animated.div style={animation}>
            <ModalWrapper>
              ...
              <ModalBody>
                <p>
                  This is an annual contest among I.C.T talents to be awarded
                  and encourage to stand tall in the world. It serves as a
                  talent hunting ground for firms to pick individuals who fit
                  into their activities. This encourages local
                  content/craftsmanship by building I.C.T inventions to solve
                  our problems based on our environment and its challenges and
                  export such (Software, Hardware and Multimedia) to other parts
                  of the world. The contest stand to bridge the gaps between
                  companies in need of capable labour and individuals with the
                  required skill, thus; solving the problem of unemployment and
                  reducing the cost of running companies locally. Who be who in
                  I.C.T stand as a show-ground for investors to build new
                  companies in the industry by leveraging on talents on-the-spot
                  basis and build them to be the world beaters.
                </p>
              </ModalBody>
            </ModalWrapper>
          </animated.div>
...
export const SecondModal = ({ showModal, setShowModal }) => {
  const modalRef = useRef();
...
export const ThirdModal = ({ showModal, setShowModal }) => {
  const modalRef = useRef();
